...
public class ArrayList<E> implements List<E> {
    ...
    public boolean equals(Object obj) {
        ...
        if (size != other.size())
            return false;
        for (int i = 0; i < size; i++) //interate through the list, returning false if any element isn't equal to the other
        {
    ...
    public void add(E e) {
        ...
        {
            E[] big = (E[]) new Object[array.length * 2]; //if the size is equal to the array length, create a new array with more space to store more elements
        ...
        array[size] = e; //adds an element to the end of the array, with [size] and increases the size afterwards
        size++;
    }
    ...
    public void add(int index, E e) throws IndexOutOfBoundsException {
        ...
        for (int i = size; i > index; i--) //starts at the end of the array and moves every element to the right until the desired index is reached, setting the array[index] to the given object
        {
            array[i] = array[i - 1];
        }
        array[index] = e;
    ...
    public E remove(int index) throws IndexOutOfBoundsException {
        ...
        for (int i = index; i < size - 1; i++) //moves all data to the left over the deleted index, removing it from the list
        {
            array[i] = array[i + 1];
        }
        size--;
